                    ...
                    <div class="col-md-5">
                        <div class="visitor">
                            <div class="row gy-5 align-items-center">
                                ...
                                <div class="col-3 px-0">
                                    <div class="img text-end">
                                        <img src="<?= base_url() ?>assets/img/v-today.png" class="img-fluid w-50"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-9">
                                ...
                                <div class="col-3 px-0">
                                    <div class="img text-end">
                                        <img src="<?= base_url() ?>assets/img/v-online.png" class="img-fluid w-50"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-9">
                                ...
                                <div class="col-3 px-0">
                                    <div class="img text-end">
                                        <img src="<?= base_url() ?>assets/img/v-total.png" class="img-fluid w-75"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-lg-5">
                            <div class="spek-img">
                                <div class="owl-carousel screenshot-carousel p-4">
                                    ...
                                    <div class="card-img">
                                        <div class="img">
                                            <a href="https://shop103.digitalindo.co.id/upload/laptop/detail_laptop/<?= $mImg->image; ?>"
                                                data-fancybox="laptop-<?= $mImg->header; ?>" data-filter="#content_C"
                                                data-caption="">
                                                <img src="https://shop103.digitalindo.co.id/upload/laptop/detail_laptop/<?= $mImg->image; ?>"
                                                    class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="spesification ps-0 ps-lg-4">
                                ...
                                <div class="btn-buy mt-5">
                                    <a href="<?= $waLink; ?>" target="_blank"
                                        class="bg-yellow px-5 py-3 fw-bold txt-blue rounded-10"><?= @$_GET['lang'] == 'eng' ? 'Buy Now' : 'Beli Sekarang' ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="spek-img">
                                ...
                                <div class="owl-carousel screenshot-carousel px-4 py-1">
                                    ...
                                    <div class="card-img">
                                        <div class="img">
                                            <a href="https://shop103.digitalindo.co.id/upload/printer/detail_printer/<?= $mImg->image; ?>"
                                                data-fancybox="printer-<?= $mImg->header; ?>" data-filter="#content_C"
                                                data-caption="">
                                                <img src="https://shop103.digitalindo.co.id/upload/printer/detail_printer/<?= $mImg->image; ?>"
                                                    class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-5">
                            <div class="spek-img">
                                ...
                                <div class="owl-carousel screenshot-carousel px-4 py-1">
                                    ...
                                    <div class="card-img">
                                        <div class="img">
                                            <a href="https://shop103.digitalindo.co.id/upload/custom/detail_custom/<?= $mImg->image; ?>"
                                                data-fancybox="custom-<?= $mImg->header; ?>" data-filter="#content_C"
                                                data-caption="">
                                                <img src="https://shop103.digitalindo.co.id/upload/custom/detail_custom/<?= $mImg->image; ?>"
                                                    class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-5">
                            <div class="spek-img">
                                ...
                                <div class="owl-carousel screenshot-carousel px-4 py-1">
                                    ...
                                    <div class="card-img">
                                        <div class="img">
                                            <a href="https://shop103.digitalindo.co.id/upload/aksesoris/detail_aksesoris/<?= $mImg->image; ?>"
                                                data-fancybox="aksesoris-<?= $mImg->header; ?>" data-filter="#content_C"
                                                data-caption="">
                                                <img src="https://shop103.digitalindo.co.id/upload/aksesoris/detail_aksesoris/<?= $mImg->image; ?>"
                                                    class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
        ...
        <div id="list-chat-section" class="list-chat-section animated fadeIn" style="display: block;">
                ...
                <div class="header-avatar-section">
                    ...
                    <div class="avatar">
                        <img class="avatar"
                            ...
                            src="https://shop103.digitalindo.co.id/upload/wa_image/<?= $sec1->image; ?>">
                    </div>
                    <? } ?>
                </div>
            ...
            <div class="chat-section">
                ...
                <div class="cs-section" onclick="chatCustomer(<?= $sec2->id; ?>);">
                    <div class="avatar">
                        <img class="avatar"
                            src="https://shop103.digitalindo.co.id/upload/wa_image/<?= $sec2->image; ?>">
                    </div>
                    <div class="profile">
            ...
            <div class="header-section" style="background: linear-gradient(180deg, #2056A0 0%, #0264EB 100%)">
                ...
                <div class="header-avatar-section">
                    <div class="avatar">
                        <img class="avatar"
                            style="position: relative; display: inline-block; vertical-align: middle; height: 60px; width: 60px; border-radius: 60px;"
                            src="https://shop103.digitalindo.co.id/upload/wa_image/<?= $sec3->image; ?>">
                    </div>
                </div>
